          ...
          <div v-for="graphObj in grafici" :key="graphObj.question" style="margin-bottom: 6rem">
            ...
            <div v-if="graphObj.type === 'bar'">
              <div v-for="grafico in graphObj.data" :key="grafico.id" style="margin-bottom: 3rem">
                ...
                <DataBarChart
                  :data="grafico.data"
                  :options="grafico.options === undefined ? barChartOptions : grafico.options"
                />
              </div>
            </div>
            <div v-else-if="graphObj.type === 'doughnut'">
              <div v-for="grafico in graphObj.data" :key="grafico.id" style="margin-bottom: 3rem">
                ...
                <DataDoughnutChart
                  :data="grafico.data"
                  :options="graphObj.percentage ? doughnutPercentageChartOptions : doughnutChartOptions"
                />
...
export default {
  data () {
    return {
      ...
      doughnutPercentageChartOptions: {
        maintainAspectRatio: true,
        responsive: true,
        tooltips: {
          enabled: true,
