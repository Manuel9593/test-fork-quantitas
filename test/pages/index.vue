              ...
              <div v-for="grafico in graphObj.data" :key="grafico.id" style="margin-bottom: 3rem">
                ...
                <div v-else-if="grafico.percentage">
                  <div v-if="grafico.separator">
                    <DataBarSeparatorPercentageChart
                      :data="grafico.data"
                    />
                  </div>
                  <div v-else>
...
import DataBarSeparatorPercentageChart from '../components/data/data-bar-separator-percentage-chart'
export default {
  components: { DataBarSeparatorPercentageChart, DataBarBigNumbersChart, DataDoughnutPercentageChart },
  data () {
    return {
      barChartOptions: {
